...
def opcao_invalida():
    """ Exibe uma mensagem de opção inválida e retorna o menu principal """
...
def listar_restaurantes():
    """ Lista os restaurante presentes na lista
    ...
    for restaurante in restaurantes:
        ...
        print(f'- {nome_restaurante.ljust(20)} | {categoria.ljust(20)} | {ativo}')  # .ljust(20) coloca espaçamento.
